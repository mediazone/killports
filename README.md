...
**[⬇️ Download KillPorts-v1.0.3.pkg](https://github.com/mediazone/killports/releases/download/v1.0.3/KillPorts-v1.0.3.pkg)** (macOS 13.0+)
...
*KillPorts v1.0.3 - Built for macOS with Swift & SwiftUI*