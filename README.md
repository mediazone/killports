...
**[⬇️ Download KillPorts-v1.0.4.pkg](https://github.com/mediazone/killports/releases/download/v1.0.4/KillPorts-v1.0.4.pkg)** (macOS 13.0+)
...
*KillPorts v1.0.4 - Built for macOS with Swift & SwiftUI*